...
class DOFA_PatchEmbed(nn.Module):
    ...
    def forward(self, img_feat, wvs):
        ...
        dynamic_out = F.conv2d(img_feat, weights, bias=bias, stride=(self.kernel_size,self.kernel_size))
...
if __name__ == "__main__":
    embed_dim = 768
    patch_embed = DOFA_PatchEmbed(wv_planes=128, inter_dim=128, kernel_size=16, embed_dim=embed_dim)
